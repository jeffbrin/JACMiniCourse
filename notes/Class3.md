...
<img src="../Assets/60fps.gif" height=400>
<img src="../Assets/30fps.gif" height=400>


In both of these, the ball is moving at 100 pixels per update function call, however they are scaled to different framerates, so the update function is called a different number of times.
